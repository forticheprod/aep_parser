...
class TestOutputFileOptions:
    ...
    def test_file_options_attributes(self) -> None:
        ...
        assert options.has_video is True
        assert options.has_audio is True
    ...
    def test_file_options_defaults(self) -> None:
        ...
        assert options.has_video is False
        assert options.has_audio is False
...
class TestOutputFileOptionsFromFile:
    ...
    def test_parse_avi_format_options(self, sample_prefs_path: Path) -> None:
        ...
        avi = avi_options[0]
        assert avi.has_video is True
        assert avi.has_audio is True
    ...
    def test_parse_wave_format_options(self, sample_prefs_path: Path) -> None:
        ...
        wave = wave_options[0]
        assert wave.has_video is False
        assert wave.has_audio is True
