...
_SOURCE_OPTIONS_SPECS: list[_PropSpec] = [
    _PropSpec("ADBE Layer Source Alternate", "Item Cache Entry", None, PropertyValueType.NO_VALUE, default_value=0),
]
...
_COMPOSITING_OPTIONS_PROPERTY_SPECS: list[_PropSpec] = [
    _PropSpec("ADBE Effect Mask Opacity", "Effect Opacity", 100.0, PropertyValueType.ONE_D, min_value=0, max_value=100),
    _PropSpec("ADBE Force CPU GPU", "GPU Rendering", 1.0, PropertyValueType.ONE_D, min_value=1, max_value=3),
]
...
_MASK_ATOM_SPECS: list[_PropSpec] = [
    _PropSpec("ADBE Mask Feather", "Mask Feather", [0.0, 0.0], PropertyValueType.TWO_D, dimensions=2, min_value=0, max_value=32000),
    _PropSpec("ADBE Mask Opacity", "Mask Opacity", 100.0, PropertyValueType.ONE_D, min_value=0, max_value=100),
    _PropSpec("ADBE Mask Offset", "Mask Expansion", 0.0, PropertyValueType.ONE_D),
]
...
def _make_property_from_spec(
    ...
    prop.default_value = spec.value if spec.default_value is _USE_VALUE else spec.default_value
