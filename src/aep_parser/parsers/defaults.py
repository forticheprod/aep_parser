...
_INNER_SHADOW_SPECS: list[_PropSpec] = [
    ...
    _PropSpec(
        "innerShadow/localLightingAngle", "Angle", 120.0, PropertyValueType.ONE_D
    ),
    _PropSpec(
...
_BEVEL_EMBOSS_SPECS: list[_PropSpec] = [
    ...
    _PropSpec(
        "bevelEmboss/localLightingAngle", "Angle", 120.0, PropertyValueType.ONE_D
    ),
    _PropSpec(
        "bevelEmboss/localLightingAltitude", "Altitude", 30.0, PropertyValueType.ONE_D
    ),
    _PropSpec(
...
_STROKE_SPECS: list[_PropSpec] = [
    ...
    _PropSpec(
        "frameFX/size", "Size", 3.0, PropertyValueType.ONE_D, min_value=1, max_value=250
    ),
    _PropSpec(
        "frameFX/opacity",
        "Opacity",
...
_BLEND_OPTIONS_GLOBAL_SPECS: list[_PropSpec] = [
    _PropSpec(
        "ADBE Global Angle2", "Global Light Angle", 120.0, PropertyValueType.ONE_D
    ),
    _PropSpec(
        "ADBE Global Altitude2", "Global Light Altitude", 30.0, PropertyValueType.ONE_D
    ),
]
