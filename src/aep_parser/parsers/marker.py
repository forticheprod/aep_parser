...
def parse_marker(
    ...
    duration = nmhd_chunk.body.duration
    ...
    return MarkerValue(
        ...
        duration=duration,
        navigation=nmhd_chunk.body.navigation,
        frame_target=str_contents(utf8_chunks[3]),
        url=str_contents(utf8_chunks[2]),
        label=Label(int(nmhd_chunk.body.label)),
        protected_region=nmhd_chunk.body.protected_region,
        params=params,
        frame_duration=nmhd_chunk.body.frame_duration,
        frame_time=frame_time,
    )
