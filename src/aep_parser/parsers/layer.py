...
def parse_layer(layer_chunk: Aep.Chunk, composition: CompItem) -> Layer:
    ...
    av_layer_attrs = {
        ...
        "blending_mode": map_blending_mode(get_enum_value(ldta_chunk.blending_mode)),
        ...
        "frame_blending_type": map_frame_blending_type(
            get_enum_value(ldta_chunk.frame_blending_type),
    ...
    if layer_type_name == "light":
        layer: Layer = LightLayer(
            **layer_attrs,
            light_type=map_light_type(get_enum_value(ldta_chunk.light_type)),
        )
