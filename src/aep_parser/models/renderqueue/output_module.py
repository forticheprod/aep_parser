...
from aep_parser.enums.mappings import map_output_audio, map_output_color_space
...
class OutputModule:
    ...
    def settings(self) -> SettingsView:
        """[SettingsView][aep_parser.models.settings.SettingsView] dict with
    ...
    def _effective_frame_rate(self) -> float:
        ...
        return rqi.comp.frame_rate  # type: ignore[no-any-return]
