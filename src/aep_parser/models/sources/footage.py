...
from aep_parser.enums import AlphaMode, FieldSeparationType
...
class FootageSource(ABC):
    ...
    value to [FieldSeparationType.OFF][aep_parser.enums.FieldSeparationType]
    if `remove_pulldown` is not [PulldownPhase.OFF][aep_parser.enums.PulldownPhase].
    """
    ...
    `alpha_mode` is [AlphaMode.IGNORE][aep_parser.enums.AlphaMode], this
    ...
    [AlphaMode.PREMULTIPLIED][aep_parser.enums.AlphaMode].
    """
